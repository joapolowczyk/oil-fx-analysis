...
print(f"\nFacebook Prophet analizys finished. Resultes saved: {OUTPUT_SENSITIVITY_EXCEL_PATH}")
...
print(f"\nFacebook Prophet forecasting finished. Results saved: {OUTPUT_RESULTS_EXCEL_PATH}")
